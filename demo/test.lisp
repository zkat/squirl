...
(defreply init ((demo =squirl-demo=))
  ...
  (let ((body (make-body))
        (floor (make-segment (vec 0 10) (vec 500 10) :elasticity 1 :friction 1))
        (left-wall (make-segment (vec 10 0) (vec 10 200) :elasticity 1 :friction 1))
        (right-wall (make-segment (vec 490 0) (vec 490 200) :elasticity 1 :friction 1)))
